...
@section("content")
            ...
            <header class="page-title-bar">
              ...
              <div class="d-md-flex align-items-md-start">
                <h1 class="page-title mr-sm-auto"> Liste des ministre</h1><!-- .btn-toolbar -->
                            ...
                            @forelse ($pasteurs as $i)
                                <tr class="gradeX">
                                    ...
                                    <td class="center align-middle text-right">
                                        ...
                                        <a href="{{ route('editMinistre',['id'=>$i->id]) }}" class="btn btn-sm btn-icon btn-secondary">
