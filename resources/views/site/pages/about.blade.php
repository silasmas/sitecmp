                ...
                <div class="accordion plus-icon shadow">
                    ...
                    <div class="acd-group">
                        ...
                        <div class="acd-des">
                            ...
                            <p>Nous sommes un carrefour, un endroit où des personnes d'arrière plans différents (races,
                                tribus, cultures, niveaux sociaux et intellectuels) se mélangent, sans aucune barrière,
                                à cause de l’expérience profonde de la nouvelle naissance et de la transformation de vie
                                en Jésus Christ.
                    ...
                    <div class="acd-group">
                        ...
                        <div class="acd-des">
                            <ol>
                                ...
                                <p>Nous savons et nous croyons que nous sommes en train de vivre les dernières heures de
                                    la vie de l’Eglise ici bas.</p>
    ...
    <div class="side-background">
        <div class="col-lg-6 img-side img-left">
            <div class="img-holder img-cover jarallax" data-speed="0.6"
                data-img-src="{{ asset('assets/images/about-img/pastor.jpg') }}">
            </div>
        </div>
    </div>
    <div class="container">
...
<section class="meet-team white-bg page-section-ptb">
    <div class="container">
        <ul class="nav  mb-5 nav-tabs nav-tab-page justify-content-center align-items-center" id="pills-tab"
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-arrivage-tab" data-bs-toggle="pill" data-bs-target="#programmes"
                    type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Nos programmes</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-categorie-tab" data-bs-toggle="pill" data-bs-target="#extensions"
                    type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Nos extensions</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="team team-hover">
                                        ...
                                        <div class="team-description">
                                            ...
                                            <div class="social-icons color clearfix">
                                                <ul>
                                                    <li class="social-facebook" {{$ps->facebook_url==""?"hidden":""}}><a
                                                            target="blank" href="{{ $ps->facebook_url }}"><i
                                                                class="fa fa-facebook"></i></a>
                                                    </li>
                                                    <li class="social-twitter" {{$ps->twitter_url==""?"hidden":""}}><a
                                                            target="blank" href="{{ $ps->twitter_url }}"><i
                                                                class="fa fa-twitter"></i></a>
                                                    </li>
                                                    <li class="social-instagram" {{$ps->
                                                        instagram_url==""?"hidden":""}}><a target="blank"
                                                            href="{{ $ps->instagram_url }}"><i
                                                                class="fa fa-instagram"></i></a>
                                                    </li>
                                                    <li class="social-youtube" {{$ps->youtube_url==""?"hidden":""}}><a
                                                            target="blank" href="{{ $ps->youtube_url }}"><i
            ...
            <div class="tab-pane fade" id="programmes" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="tab-pane fade" id="extensions" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">

            </div>
            <div class="tab-pane fade" id="cellules" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center mb-80">
                            <h6>Rejoignez-nous et participez à nos célébrations dont voici les horaires</h6>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <iframe src="{{ asset("assets/document/cellules.pdf") }}" width="100%" height="650px"></iframe>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 align-self-end">
                <img class="d-xs-block d-lg-block d-none img-fluid"
                    src="{{ asset('assets/site/images/objects/testimonial.jpg') }}" alt="">
            </div>
