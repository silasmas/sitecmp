        ...
        <div class="topbar-call text-center text-md-start">
          <ul>
            <li><i class="fa fa-envelope-o" style="color: #fff;"></i> contact@cmp.com</li>
             <li><i class="fa fa-phone" style="color: #fff;"></i> <a href="tel:+243123456789"> <span>+(243) 123456789 </span> </a> </li>
          </ul>
        </div>
      </div>
      ...
      <div class="row">
       <div class="col-lg-12 col-md-12 position-relative">
        ...
        <div class="menu-bar">
         ...
         <li><a href="galerie.html">Medias </a></li>
         <li><a href="contact.html">Conatct </a></li>
        </ul>
        <div class="search-cart">
          <div class="shpping-cart" >
            <a class="cart-btn" href="#"> <i class="fa fa-user icon" style="color: #650f1c;"></i></a>
             <div class="cart">
    ...
    <div class="row">
      ...
      <div class="page-title-name">
          ...
          <ul class="page-breadcrumb">
            ...
            <li><a href="#">portfolio</a> <i class="fa fa-angle-double-right"></i></li>
     ...
     <div class="row">
      <div class="col-lg-7">
         <div class="who-we-are-left port-singal">
          ...
          <div class="item"><img src="images/portfolio/01.jpg" alt="">
          </div>
          <div class="item"><img src="images/portfolio/02.jpg" alt="">
          </div>
          <div class="item"><img src="images/portfolio/03.jpg" alt="">
          </div>
         </div>
        </div>
      </div>
   ...
   <div class="row">
     ...
     <div class="col-lg-4 col-sm-6">
       ...
       <div class="footer-widget mt-20">
         <div class="row">
           <div class="col-lg-6 col-md-6">
            <p class="mt-15"> &copy;Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="#"> CMP </a> All Rights Reserved </p>
           </div>
