...
@section("content")
        <section class="rev-slider">
            ...
            <div id="rev_slider_267_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
                ...
                <div id="rev_slider_267_1" class="rev_slider fullwidthabanner" style="display:none;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-755" data-transition="random-static,random-premium,random"
                            ...
                            data-thumb="{{ asset('assets/site/revolution/assets/slider-01/70x70_1a353-01.jpg') }}" data-rotate="0,0,0,0"
                            data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3=""
                            data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                            data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('assets/site/revolution/assets/slider-01/1a353-01.jpg') }}" alt="" data-bgposition="center center"
                            ...
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption   tp-resizeme" id="slide-755-layer-5" data-x="center"
                                data-hoffset="-353" data-y="center" data-voffset="80" data-width="['auto']"
                                data-height="['auto']" data-type="text" data-responsive_offset="on"
                            ...
                            <a class="tp-caption rev-btn  tp-resizeme  rev-button" href="#" target="_self"
                                id="slide-755-layer-15" data-x="center" data-hoffset="" data-y="center"
                                data-voffset="160" data-width="['auto']" data-height="['auto']" data-type="button"
                        ...
                        <li data-index="rs-756" data-transition="random-static,random-premium,random"
                            ...
                            data-easein="default,default,default,default" data-easeout="default,default,default,default"
                            data-masterspeed="default,default,default,default"
                            data-thumb="{{ asset('assets/site/revolution/assets/slider-01/70x70_02483-02.jpg') }}" data-rotate="0,0,0,0"
                            data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3=""
                            data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                            data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('assets/site/revolution/assets/slider-01/02483-02.jpg') }}" alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <!-- LAYER NR. 14 -->
                            <a class="tp-caption tp-resizeme" href="#" target="_self" id="slide-756-layer-13"
                                data-x="235" data-y="center" data-voffset="180" data-width="['auto']"
                ...
                <div class="row">
                    <div class="col-md-4 xs-mb-40">
                        <div class="feature-box h-100 active">
                            ...
                            <a href="#">Read more</a>
                            <div class="feature-box-img" style="background-image: url('assets/site/images/about/01.jpg');"></div>
                    ...
                    <div class="col-md-4 xs-mb-40">
                        <div class="feature-box h-100 active">
                            ...
                            <a href="#">Read more</a>
                            <div class="feature-box-img" style="background-image: url('assets/site/images/about/02.jpg');"></div>
                            <span class="feature-border"></span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box h-100 active">
                            ...
                            <a href="#">Read more</a>
                            <div class="feature-box-img" style="background-image: url('assets/site/images/about/03.jpg');"></div>
                            <span class="feature-border"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="section-title">
                            <h6>Le couple</h6>
                            <h2 class="title-effect">KEN & NATHALIE LUAMBA</h2>
        ...
        <section class="awesome-features gray-bg page-section-ptb pos-r">
            ...
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-lg-7">
                        <div class="section-title">
                            <h6>Ce que nous sommes </h6>
                            <h2 class="title-effect">A Propos</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title">
                                ...
                                <p class="text-white">We are dedicated to providing you with the best experience
                                    possible. Read below to find out why the sky's the limit when using Webster.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="isotope popup-gallery columns-3 no-padding">
                            <div class="grid-item">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-overlay">
                                        ...
                                        <span class="text-white"> <a href="#"> Photography </a>| <a href="#">Ecommerce
                                            </a> </span>
                                    </div>
                                    <a class="popup portfolio-img" href="{{ asset('assets/site/images/portfolio/small/01.jpg') }}"><i
                            ...
                            <div class="grid-item">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-overlay">
                                        ...
                                        <span class="text-white"> <a href="#"> Creative </a>| <a href="#">Graphics </a>
                                        </span>
                                    </div>
                                    <a class="popup portfolio-img" href="{{ asset('assets/site/images/portfolio/small/02.jpg') }}"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                            <div class="grid-item">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-overlay">
                                        ...
                                        <span class="text-white"> <a href="#"> Design </a>| <a href="#">Illustration
                                            </a> </span>
                                    </div>
                                    <a class="popup portfolio-img" href="{{ asset('assets/site/images/portfolio/small/03.jpg') }}"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                            <div class="grid-item">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-overlay">
                                        ...
                                        <span class="text-white"> <a href="#"> Animation </a>| <a href="#">GIF </a>
                                        </span>
                                    </div>
                                    <a class="popup portfolio-img" href="{{ asset('assets/site/images/portfolio/small/04.jpg') }}"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                            <div class="grid-item">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-overlay">
                                        <h4 class="text-white"> <a href="portfolio-single-01.html"> Post item
                                                Youtube</a> </h4>
                                        <span class="text-white"> <a href="#"> Video </a>| <a href="#">Youtube </a>
                                        </span>
                                    </div>
                            ...
                            <div class="grid-item">
                                <div class="portfolio-item">
                                    ...
                                    <a class="popup portfolio-img" href="{{ asset('assets/site/images/portfolio/small/06.jpg') }}"><i
                                            class="fa fa-arrows-alt"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="pricing-table active">
                            <div class="pricing-top">
                                <div class="pricing-title">
                                    <h3 class="mb-15">Mercredi</h3>
                                    <p>Culte d'enseignement biblique</p>
                                </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="pricing-table active">
                            <div class="pricing-top">
                                <div class="pricing-title">
                                    <h3 class="mb-15">Jeudi</h3>
                                    <p>Culte d'intercession (Jeudi Etoko)</p>
                                </div>
                                <div class="pricing-prize">
                                    <h3>17h30 - 19h30</h3>
                                </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="pricing-table active">
                            <div class="pricing-top">
                                <div class="pricing-title">
                                    <h3 class="mb-15">Samedi</h3>
                                    <p>Réunion de la jeunesse</p>
                                </div>
                                <div class="pricing-prize">
                                    <h3>16h30 - 18h30</h3>
                                </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="pricing-table active">
                            <div class="pricing-top">
                                <div class="pricing-title">
                                    <h3 class="mb-15">Dimanche</h3>
                                    <p>Culte dominical</p>
                                    <p>07h00-8h30; 09h30 -11h00; 12h00-13h30 </p>
                                </div>
                                <div class="pricing-prize">
                                    <h3>17h30 - 19h30</h3>
                                </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6 align-self-end">
                     <img class="d-xs-block d-lg-block d-none img-fluid" src="{{ asset('asets/site/images/objects/testimonial.jpg') }}" alt="">
                </div>
                 ...
                 <div class="tab-pane fade show active" id="testi-01">
                  ...
                  <div class="tab-pane fade" id="testi-04">
                   ...
                   <ul class="nav nav-tabs mt-60" id="myTab" role="tablist">
                     <li><a class="nav-item active" href="#testi-01" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('assets/site/images/team/01.jpg') }}" alt=""> </a></li>
                     <li><a class="nav-item" href="#testi-02" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('assets/site/images/team/02.jpg') }}" alt=""> </a></li>
                     <li><a class="nav-item" href="#testi-03" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('assets/site/images/team/03.jpg') }}" alt=""> </a></li>
                     <li><a class="nav-item" href="#testi-04" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('assets/site/images/team/04.jpg') }}" alt=""> </a></li>
                    </ul>
                 </div>
               </div>
              </div>
