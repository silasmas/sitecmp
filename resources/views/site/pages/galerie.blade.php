                ...
                <div class="isotope columns-5 popup-gallery">
                    ...
                    <div class="grid-item illustration">
                        <div class="portfolio-item">
                            ...
                            <a class="popup portfolio-img"
                                href="{{ asset('assets/site/images/portfolio/small/04.gif') }}"><i
                                    class="fa fa-arrows-alt"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-item web-design photography">
                        <div class="portfolio-item">
                            ...
                            <a class="popup portfolio-img"
                                href="{{ asset('assets/site/images/portfolio/small/07.jpg') }}"><i
                                    class="fa fa-arrows-alt"></i></a>
                        </div>
                    </div>
                    <div class="grid-item web-design photography">
                        <div class="portfolio-item">
                            ...
                            <a class="popup portfolio-img"
                                href="{{ asset('assets/site/images/portfolio/small/08.gif') }}"><i
                                    class="fa fa-arrows-alt"></i></a>
                        </div>
                    </div>
                    <div class="grid-item web-design photography">
                        <div class="portfolio-item">
                            ...
                            <a class="popup portfolio-img"
                                href="{{ asset('assets/site/images/portfolio/small/09.jpg') }}"><i
                                    class="fa fa-arrows-alt"></i></a>
                        </div>
                    </div>
                    <div class="grid-item web-design photography">
                        <div class="portfolio-item">
                            ...
                            <a class="popup portfolio-img"
                                href="{{ asset('assets/site/images/portfolio/small/10.jpg') }}"><i
                                    class="fa fa-arrows-alt"></i></a>
                        </div>
                    </div>
                    <div class="grid-item web-design photography">
