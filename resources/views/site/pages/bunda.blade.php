        ...
        <div class="row g-lg-5 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="section-title">
                    ...
                    <p>
                        La grande célébration Bunda 21 est un programme de 21 jours de jeûne et prière pendant lesquels
                        nous cherchons la face de Dieu pour nous-mêmes, pour nos ministères, nos mariages, pour nos
                        business, nos Églises, notre pays.

                        Il y a bien de choses que Dieu nous a destinées, qui nous appartiennent, mais que nous devons
                        palper, posséder.
                        Le prophète Elie, après avoir reçu une promesse de Dieu, a cherché Dieu à la montagne ; il s’est
...
<section class="meet-team gray-bg page-section-ptb">
    <div class="container">
        <ul class="nav  mb-5 nav-tabs nav-tab-page justify-content-center align-items-center" id="pills-tab"
            ...
            {{-- <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-categorie-tab" data-bs-toggle="pill" data-bs-target="#logement"
                    type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Logément</button>
            </li>--}}
            <li class="nav-item" role="presentation">
                       ...
                       <form action="{{ route('temoignage') }}" method="post" id="newsletter">
                        ...
                        <div class="contact-form border-form clearfix">
                            <div class="section-field">
                                <input type="text" placeholder="Nom complet" class="form-control" name="fullname" required>
                            </div>
                            <div class="section-field">
                                <input type="email" placeholder="Email (optionnel)" class="form-control" name="email">
                            </div>
                            <div class="section-field">
                                <input type="text" placeholder="Téléphone" class="form-control" name="phone" required>
                            </div>
                            ...
                            <button name="submit" type="submit" value="Send" class="button mt-30"><span> Send message
