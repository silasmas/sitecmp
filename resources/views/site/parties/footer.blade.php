                ...
                <div class="footer-useful-link footer-hedding">
                    ...
                    <ul>
                        <li ><a href="index.html">@lang('miscellaneous.main_menu.home') </a></li>
                                    ...
                                    <li><a href="{{ route('events') }}">@lang('miscellaneous.main_menu.events') </a></li>
                                    <li><a href="{{ route('projects') }}">@lang('miscellaneous.main_menu.projects')  </a></li>
                                    <li><a href="{{ route('contributions') }}">@lang('miscellaneous.main_menu.contribution')  </a></li>
                                    <li><a href="{{ route('galerie') }}">@lang('miscellaneous.main_menu.gallery')  </a></li>
                                    <li><a href="{{ route('contact') }}">@lang('miscellaneous.main_menu.who_are_we.contact')  </a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-sm-6 sm-mb-30">
